 ...
 */
class NFTDeals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NFT_deals';
     ...
     * Sets status
     *
     * @param string|null $status Overall deal status
     *
     * @return self
     */
